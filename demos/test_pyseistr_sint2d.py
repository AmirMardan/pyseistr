...
x1=30
x2=60
inds=[ii for ii in range(0,n1*n2) if t[ii]>(x1-1)*n2 and t[ii]<=x2*n2]
raw[inds]=0
...
dip=ps.dip2dc(ps.bandpassc(data,0.004,
                           flo=0,fhi=10),
              mask=datam,
              order=2,
              rect=[10,10,1],
